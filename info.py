...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kkhanyaseen:khan1234@cluster0.tyguiox.mongodb.net/?retryWrites=true&w=majority")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'RequestGroup17')
